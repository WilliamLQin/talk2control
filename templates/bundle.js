...
/******/ 	var hotCurrentHash = "4708e4bd6254d4bf1d03"; // eslint-disable-line no-unused-vars
...
var _Recorder = __webpack_require__(28);
...
var Recorder = function (_React$Component) {
  ...
  _createClass(Recorder, [{
    key: 'startRecording',
    value: function startRecording(foo) {
      // foo.start();
      console.log(foo);
    }
  }, {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'p',
          null,
          'Record Keyword Command'
        ),
        _react2.default.createElement(
          'button',
          { id: 'btn-1', onClick: function onClick() {} },
          'Record'
        ),
        _react2.default.createElement('textarea', { className: 'text-area', defaultValue: this.state.text })
      );
    }
  }]);
